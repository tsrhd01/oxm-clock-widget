...
// index.js
var Clock_default = Node2.create({
  name: "ClockX",
  group: "block",
  atom: true,
  addAttributes() {
  ...
  renderHTML({ HTMLAttributes }) {
    return ["clockx-view", mergeAttributes(HTMLAttributes)];
  },
  addNodeView() {
...
`;
      function updateClock() {
        ...
        dom.querySelector("#hour").style.transform = `rotate(${30 * hour + minute / 2}deg)`;
        dom.querySelector("#minute").style.transform = `rotate(${6 * minute}deg)`;
        dom.querySelector("#second").style.transform = `rotate(${6 * second}deg)`;
      }
